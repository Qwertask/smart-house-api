...
type Repository interface {
	...
	ReadDs18b20SensorRecord(ctx context.Context) (*models.DS18B20Sensor, error)
	ReadClimateControlRecord(ctx context.Context, deviceName string) (*models.ClimateControl, error)
	ReadDHT22SensorRecord(ctx context.Context, deviceID int) (*models.DHT22Sensor, error)
	ReadDoorSensorRecord(ctx context.Context) (*models.DoorSensor, error)
